 ...
 **(성숙도 측정 특화)** DAMA-DMBOK가 **무엇을(What)** 관리해야 하는지 지식 체계라면, DCAM은 **얼마나 잘(How Well)** 하고 있는지 성숙도 측정에 특화.  
 **(금융 규제 연계)** Basel III·BCBS 239 등 금융 규제의 데이터 품질·거버넌스 요건 충족을 위한 평가 기준으로 광범위 활용.  
