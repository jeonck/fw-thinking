...
**특징**:  
 **(산업 중립성)** 특정 도구·기술에 종속되지 않는 **산업 중립적(Cross-Industry)** 표준 프로세스.  
 **(반복적 개선)** 단방향 진행이 아닌 **각 단계 간 피드백과 반복(Iteration)** 을 통한 점진적 품질 향상.  
 **(공통 언어)** 데이터 분석가와 비즈니스 이해관계자 간의 **공통 언어**로 협업 효율화.  
