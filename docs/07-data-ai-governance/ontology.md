...
## 1. 개념 간 관계를 형식적으로 정의하여 기계가 이해할 수 있는 지식 체계를 구축하는 프레임워크, 온톨로지의 개요
...
**개념**: 특정 도메인의 개념(클래스)과 개념 간의 관계(속성·제약)를 형식적 언어로 정의하여, 사람과 시스템이 공유하고 재사용할 수 있는 **공식적이고 명시적인 지식 표현 체계**.
