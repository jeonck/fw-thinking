...
**특징**:  
 **(DAMA Wheel)** 데이터 거버넌스를 중심축으로 10개 관리 영역이 유기적으로 연결된 **DAMA Wheel** 구조 제시.  
 **(비즈니스 자산 관점)** 데이터를 IT 자산이 아닌 **전사 비즈니스 자산**으로 인식하는 관점 전환 지원.  
 **(성숙도 기준)** 데이터 관리 성숙도(Maturity) 진단 및 조직 역량 개선 로드맵 수립의 기준 제공.  
