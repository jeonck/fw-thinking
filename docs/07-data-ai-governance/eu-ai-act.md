...
**정의**: AI 시스템이 가져올 수 있는 위험을 체계적으로 분류하고, 위험 수준에 따라 차등적 의무를 부과하여 안전하고 투명한 AI 도입을 보장하기 위해 유럽연합(EU)이 2024년 제정한 **세계 최초의 포괄적 AI 규제 법안**.
 ...
 **(글로벌 표준화)** GDPR에 이어 AI 분야에서도 글로벌 규제 표준화의 기준점으로 작용.  
