...
**특징**:  
 **(공유·재사용)** 공유 서비스(Shared Services)와 재사용 가능한 컴포넌트 식별을 통한 연방 IT 투자 최적화.  
 **(CPIC 연계)** OMB(행정관리예산처) 주도의 연방 IT 투자 심의(CPIC)와 연계하여 예산 배분의 근거로 활용.  
 **(공공 부문 특화)** TOGAF·DoDAF와 달리 정부·공공 부문 특화 — 시민 서비스 제공과 부처 간 협력 중심.  
