...
**특징**:  
 **(4대 뷰 체계)** AV·OV·SV·TV 4대 뷰 체계(DoDAF 1.0)에서 DoDAF 2.0에서 8개 뷰 계층으로 확장.  
 **(국방 도메인 특화)** TOGAF·Zachman과 달리 국방·군사·보안 도메인 특화 — 임무(Mission) 중심 아키텍처 설계.  
 **(JCIDS 연계)** 미 국방부 JCIDS(합동능력통합개발시스템) 및 국내 국방 정보화 체계와 연계.  
