...
```
**개념**: IT 투자를 개별 프로젝트 단위가 아닌 통합된 자산 집합(Portfolio) 관점에서 분석하여, 위험을 최소화하고 비즈니스 가치를 극대화하도록 자원을 배분하는 기법.

**특징**: 재무 포트폴리오 이론을 IT에 적용, 위험-수익(Risk-Return) 균형 추구, 비즈니스 전략과의 일치성 강화.
