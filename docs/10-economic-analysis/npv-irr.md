...
**특징**:  
 **(화폐 시간 가치)** 미래 현금흐름을 현재가치로 할인하여 장기 IT 투자의 진정한 경제적 가치를 산출.  
 **(상호 보완)** NPV(절대적 가치)와 IRR(수익률)을 함께 활용하여 투자 타당성을 다각도로 검증.  
 **(의사결정 기준)** NPV>0·IRR>자본비용이면 투자 타당성이 확보되어 경영진 승인의 객관적 근거를 제공.  
