...
**특징**:  
 **(비용·전문성·유연성)** 비용 절감, 전문성 확보, 유연한 자원 확장을 위해 IT 기능을 외부로 이전.  
 **(SLA 정량 관리)** SLA를 계약의 핵심 도구로 활용하여 서비스 수준의 정량적 관리 가능.  
 **(다양한 아웃소싱 방식)** 완전 아웃소싱(Total), 선택적 아웃소싱(Selective), 공동 소싱(Co-sourcing) 등 다양한 방식 존재.  
