...
## 1. 경영 전략과 IT를 정렬하여 정보화 로드맵을 수립하는 방법론, ISP의 개요
```mermaid
flowchart LR
    A["전략 부재/파편화"] -- "비즈니스 정렬 기반 전환" --> B["정보화 전략 로드맵"]
```
**정의**: 조직의 중장기 비즈니스 목표를 지원하기 위해 정보기술의 최적화 전략 및 로드맵을 수립하는 상위 계획 방법론.

**특징**: 
- 경영 전략과 IT 전략의 정렬(Alignment).
- 기술/프로세스/데이터에 대한 통합 청사진 제시.
