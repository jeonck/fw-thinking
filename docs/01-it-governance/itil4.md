...
**특징**:  
 **(SVS 전환)** ITIL v3 프로세스 중심에서 서비스 가치 시스템(SVS)으로 패러다임 전환.  
 **(4차원 모델)** 조직·정보·파트너·기술 4차원으로 서비스를 입체적으로 설계·운영.  
 **(Agile 통합)** Agile·DevOps·Lean 방법론과 통합하여 빠른 가치 전달과 안정성을 동시에 추구.  
