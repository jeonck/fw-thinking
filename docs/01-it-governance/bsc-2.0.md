...
## 1. 전략·디지털 성과를 통합 정렬하는 차세대 균형 성과 관리, BSC 2.0의 개요
```mermaid
flowchart LR
    A["전통적 재무 중심 성과"] -- "전략적 관점 기반 전환" --> B["전략 중심 성과관리 체계"]
```
**정의**: 디지털 전환(DX) 시대에 맞춰 기존 BSC의 4대 관점을 고도화하고, 전략-성과-실행 간의 정렬(Alignment)을 강화한 성과 관리 프레임워크.

**특징**: 
- **전략 중심**: 전사 전략과 성과 지표의 인과관계 가시화.
- **DX 정렬**: 디지털 성숙도 및 민첩성 지표 반영.
