...
```
**정의**: 조직의 의사결정권자(이사회)가 IT 활용을 효과적, 효율적, 수용 가능하게 관리할 수 있도록 지원하는 IT 거버넌스 표준 모델.

**특징**:  
 **(비즈니스 중심)** 기술이 아닌 비즈니스 관점의 상향식(Top-down) 거버넌스 접근을 강조.  
 **(6대 원칙)** 책임·전략·취득·성과·적합성·인간 행동 6개 원칙으로 IT 거버넌스 방향을 제시.  
 **(EDM 모델)** Evaluate·Direct·Monitor 3가지 활동으로 거버넌스와 관리의 책임을 명확히 분리.  
