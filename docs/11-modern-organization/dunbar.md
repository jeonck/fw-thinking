...
## 1. 사회적 관계 인지 한계로 조직 규모를 설계하는 원칙, Dunbar's Number의 개요
...
**정의**: 영국 인류학자 Robin Dunbar가 영장류의 신피질(Neocortex) 크기와 집단 규모의 상관관계 연구에서 도출한 이론으로, 인간이 **안정적인 사회적 관계를 유지할 수 있는 상한선은 약 150명** 이며, 이를 중심으로 5·15·50·150·500의 동심원 계층 구조로 친밀도별 관계 용량을 정의하는 사회 인지 이론.

**특징**:  
 **(150명 임계점)** 150명을 초과하면 공식적 규칙·계층·관료제 없이는 집단을 유지하기 어려워짐.  
 **(실무 적용 사례)** Spotify의 Squad/Tribe 모델·Amazon의 "Two-Pizza Rule"·Gore-Tex의 150명 공장 분리 정책이 던바의 수를 실무에 적용한 사례.  
 **(원격 협업 적용)** 팀 크기뿐 아니라 **원격 근무·비동기 협업 환경** 에서 관계 유지 비용이 더 높아져 더 작은 팀 설계가 중요해짐.  
