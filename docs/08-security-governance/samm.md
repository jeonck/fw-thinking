...
## 1. SW 개발 전 생애주기 보안 역량을 단계적으로 측정·향상하는 프레임워크, OWASP SAMM의 개요
...
**정의**: OWASP가 개발한 소프트웨어 보안 보증 프레임워크로, 조직의 SW 개발 프로세스 전반에 걸쳐 보안 활동을 **5대 비즈니스 기능·15개 보안 실천** 으로 체계화하고, 각 실천의 성숙도를 0~3단계로 측정하여 현행 역량 진단과 목표 수준 달성을 위한 로드맵을 제공하는 성숙도 모델.

**특징**:  
 **(방법론 비종속)** 개발 방법론(Waterfall·Agile·DevOps) **비종속적** — 어떤 개발 환경에도 적용 가능.  
 **(선택적 실천)** 조직 규모·업종에 맞게 **선택적 실천** 가능 — 15개 중 우선순위를 정해 점진적 도입.  
 **(오픈소스 프레임워크)** BSIMM·ISO/IEC 27034와 상호 보완적으로 활용 가능한 **오픈 소스** 프레임워크.  
