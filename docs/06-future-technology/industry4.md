...
## 1. 디지털 기술과 물리적 생산이 융합하여 자율적·지능적 제조를 실현하는 4차 산업혁명, Industry 4.0의 개요
...
**개념**: 독일 정부가 2011년 제안한 제조업 혁신 전략으로, **사이버 물리 시스템(CPS)** 을 통해 물리적 생산 설비와 디지털 세계를 실시간으로 연결하고, IoT·AI·빅데이터·로봇 등 9대 핵심 기술을 통합하여 자율적이고 지능적인 **스마트 팩토리(Smart Factory)** 를 구현하는 제조업 디지털 전환 패러다임.
