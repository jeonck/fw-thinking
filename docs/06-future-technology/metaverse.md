...
## 1. 물리적 현실과 디지털 가상 공간이 융합하여 사용자가 실재감을 갖고 상호작용하는 차세대 인터넷 패러다임, 메타버스의 개요
...
**개념**: Neal Stephenson의 소설 "Snow Crash"(1992)에서 유래한 개념으로, **물리적 현실(Physical Reality)** 과 **디지털 가상 공간(Virtual Space)** 이 융합되어 사용자가 아바타로 상호작용하고, 경제·사회·문화 활동을 영위하는 **지속적·몰입형·상호작용적 3D 디지털 공간** 의 총칭.
