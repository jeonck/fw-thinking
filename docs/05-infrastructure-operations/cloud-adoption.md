...
**특징**:  
 **(민첩성 중심)** 비용 절감보다 민첩성(Agility)·확장성(Scalability) 확보를 전략적 우선순위로 삼음.  
 **(하이브리드 전략)** 멀티·하이브리드 클라우드 전략으로 벤더 종속을 방지하고 유연성을 극대화.  
 **(6R 전환)** Rehost·Replatform·Refactor 등 6R 전략으로 워크로드 특성에 맞는 전환 경로를 선택.  
