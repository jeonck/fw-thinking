...
**특징**:  
 **(계약 의무)** 법정 의무가 아닌 **계약 의무** — 미준수 시 카드 브랜드와의 계약 해지·과징금 부과.  
 **(Level 1~4 구분)** 카드 처리 거래량에 따라 **Level 1~4** 로 구분하며 검증 방식(QSA·SAQ) 상이.  
 **(v4.0 강화)** 2022년 PCI-DSS v4.0 발표 — 목표 기반 접근, 다중 인증 강화, 지속적 보안 문화 강조.  
