...
```
**정의**: 유럽 연합(EU)에서 온라인 플랫폼 및 중개 서비스 제공자의 책임성을 강화하고, 온라인 환경에서 이용자의 권리를 보호하며, 불법 콘텐츠 및 서비스 확산을 방지하기 위해 제정된 규제 법안.

**특징**:  
 **(차등 규제)** 서비스 유형과 규모에 따라 의무를 차등 적용하여 규제 비례성을 확보.  
 **(VLOP 강규제)** 초대형 플랫폼(VLOPs)·검색 엔진(VLOSEs)에 알고리즘 투명성·독립 감사 등 엄격한 의무 부과.  
 **(사용자 권익)** 추천 알고리즘 설명 의무·불법 콘텐츠 신속 처리 등으로 사용자 권익을 실질적으로 보호.  
