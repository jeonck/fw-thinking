...
| **온라인 플랫폼 (Online Platforms)** | - 위의 의무 + </br>- 사용자 인터페이스 투명성 <br>- 온라인 분쟁 해결 절차 제공 <br>- 허위 정보 확산 방지 조치 | 마켓플레이스, 소셜 미디어 등 |
| **VLOPs/VLOSEs** (매우 큰 온라인 플랫폼/검색 엔진) | - 위의 의무 + </br>- 연례 위험 평가 및 완화 조치 <br>- 외부 독립 감사 의무 <br>- 알고리즘 투명성 및 설명 의무 <br>- 데이터 접근 권한 제공 (연구자 등) | 월간 활성 이용자 1,500만 명 이상 (EU 기준) |
