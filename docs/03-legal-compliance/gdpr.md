...
```
**정의**: 유럽 연합(EU) 시민의 개인정보 보호를 강화하고 EU 역내외로 이전되는 개인정보를 통제하기 위해 제정된 통합 법령.

**특징**:  
 **(역외 적용)** EU 외 기업이라도 EU 시민 대상 서비스를 제공하면 GDPR 전면 적용.  
 **(강력한 제재)** 위반 시 전 세계 연간 매출액 최대 4% 또는 2,000만 유로 과징금 부과.  
 **(광범위한 권리)** 열람·정정·삭제·이동권 등 정보 주체의 포괄적 권리를 법적으로 보장.  
