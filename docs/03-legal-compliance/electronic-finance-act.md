...
```mermaid
flowchart LR
    A["전통적 금융 거래"] -- "안전한 디지털 금융 인프라 전환" --> B["전자금융거래법"]
```
**정의**: 전자금융거래의 법률관계를 명확히 하고, 안전성과 신뢰성을 확보하여 금융산업의 발전을 도모하기 위해 제정된 법률.

**특징**:  
 **(진입 규제)** 전자금융업자 등록·허가 요건을 규정하여 안전한 시장 참여 기준을 확립.  
 **(이용자 보호)** 사고 책임·분쟁 해결·손해 배상 등 이용자 보호 의무를 명확히 규정.  
 **(금융보안 기준)** 전자금융감독규정의 상위법으로서 기술적·관리적 보안 기준의 법적 근거를 제공.  
